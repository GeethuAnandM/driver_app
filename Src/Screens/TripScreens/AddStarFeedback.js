...
const AddStarFeedback = () => {
  ...
  useEffect(() => {
    if (imageStore.EndFeedback.verified === true) {
      setIsDisable(true);
      //console.log("from fedback",imageStore.EndFeedback.verified);
  ...
  const customerFeedbackValidation =
    tripStore.updatedSelectedTrip.customerFeedbackValidation;
...
export default observer(AddStarFeedback);
